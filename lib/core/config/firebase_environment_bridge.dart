...
class FirebaseEnvironmentBridge {
  ...
  static String getEnvironmentVariable(String key, {String defaultValue = ''}) {
    ...
    switch (key) {
      ...
      case 'FIREBASE_PROJECT_ID':
        return const String.fromEnvironment('FIREBASE_PROJECT_ID', defaultValue: 'durunotes');
      case 'FIREBASE_MESSAGING_SENDER_ID':
        return const String.fromEnvironment('FIREBASE_MESSAGING_SENDER_ID', defaultValue: '259019439896');
      case 'FIREBASE_ANDROID_APP_ID':
        return const String.fromEnvironment('FIREBASE_ANDROID_APP_ID', defaultValue: '1:259019439896:android:2ea0fc35a3cc360bbce86d');
      case 'FIREBASE_IOS_APP_ID':
        return const String.fromEnvironment('FIREBASE_IOS_APP_ID', defaultValue: '1:259019439896:ios:3ba3482d4245378dbce86d');
      case 'FIREBASE_STORAGE_BUCKET':
        return const String.fromEnvironment('FIREBASE_STORAGE_BUCKET', defaultValue: 'durunotes.firebasestorage.app');
      case 'FIREBASE_IOS_BUNDLE_ID':
        return const String.fromEnvironment('FIREBASE_IOS_BUNDLE_ID', defaultValue: 'com.fittechs.duruNotesApp');
      default:
        return defaultValue;
    }
  }
  ...
  static FirebaseOptions _getAndroidOptions() {
    ...
    final appId = getEnvironmentVariable('FIREBASE_ANDROID_APP_ID',
        defaultValue: '1:259019439896:android:2ea0fc35a3cc360bbce86d');
    final messagingSenderId = getEnvironmentVariable('FIREBASE_MESSAGING_SENDER_ID',
        defaultValue: '259019439896');
    final projectId = getEnvironmentVariable('FIREBASE_PROJECT_ID',
        defaultValue: 'durunotes');
    final storageBucket = getEnvironmentVariable('FIREBASE_STORAGE_BUCKET',
  ...
  static FirebaseOptions _getIosOptions() {
    ...
    final appId = getEnvironmentVariable('FIREBASE_IOS_APP_ID',
    ...
    final storageBucket = getEnvironmentVariable('FIREBASE_STORAGE_BUCKET',
        defaultValue: 'durunotes.firebasestorage.app');
    final iosBundleId = getEnvironmentVariable('FIREBASE_IOS_BUNDLE_ID',
