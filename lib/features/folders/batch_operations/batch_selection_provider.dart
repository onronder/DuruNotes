...
class BatchSelectionNotifier extends StateNotifier<BatchSelectionState> {
  ...
  void invertSelection(List<String> allNoteIds) {
    ...
    final invertedSelection = Set<String>.from(allNoteIds)
...
final batchOperationCapabilitiesProvider = Provider<BatchOperationCapabilities>((ref) {
...
final batchOperationsProvider = StateNotifierProvider<BatchOperationsNotifier, AsyncValue<void>>((ref) {
