...
/// Calendar day widget with visual indicators for tasks using domain entities
/// Production-grade replacement for CalendarDayWidget with domain.Task support
class DomainCalendarDayWidget extends StatelessWidget {
  const DomainCalendarDayWidget({
    super.key,
    required this.date,
    required this.tasks,
...
/// Compact calendar month widget using domain entities
class DomainCalendarMonthWidget extends StatelessWidget {
  const DomainCalendarMonthWidget({
    super.key,
    required this.month,
  ...
  final Map<DateTime, List<domain.Task>> tasksByDate;
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return DomainCalendarDayWidget(
              date: date,
              tasks: tasks,
...
/// (No domain entity changes needed - this is UI-only)
