-- Quick Capture Widget Migration
-- Run this script manually in Supabase SQL Editor
-- Generated: 2025-09-17T06:10:03.674Z
...
-- This supports efficient filtering of widget-created notes
...
BEGIN
    ...
    SELECT 
        ...
        END as snippet,
        n.created_at,
        -- Parse encrypted_metadata safely
        CASE 
            WHEN n.encrypted_metadata IS NOT NULL 
            THEN n.encrypted_metadata::jsonb
            ELSE '{}'::jsonb
        END as metadata,
        n.is_pinned,
        -- Get associated tags
